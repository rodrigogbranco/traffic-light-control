...
gnuplot << EOF
	...
	set output "/home/rodrigo/spare-gnuplot.png"
	set style fill solid border lc rgb "black"

	set key top left
	set xlabel "Queue Length (m)"
    set ylabel "Spare Time (s)"
	set grid
	...
	plot '/home/rodrigo/spare.dat' using 1:2 with linespoints linestyle 2 t "kapusta:v=50km/h,ct=60s", \
